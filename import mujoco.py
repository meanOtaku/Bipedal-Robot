...
def update_keys():
    ...
    key_up = motion_command == "forward"
    key_down = motion_command == "backward"
    key_left = motion_command == "turn_left"
    key_right = motion_command == "turn_right"
